...
/**
 * Implements a ring buffer of items.  Items are inserted until maximum size is reached and then the earliest
...
public final class RingBuffer<K> {
     ...
     * <li>If the buffer is full the oldest entry in the buffer is ejected.</li>
     * </ul>
     *
     * @param item
     ...
     * If the buffer is full this will return the oldest value in the buffer.
     * If the buffer is not full this method will return {@code null}.
     *
