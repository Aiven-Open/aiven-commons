...
/**
 * Builds Config Keys.
 * @param <T> The Class of the ConfigKeyBuilder.
 */
public class ConfigKeyBuilder<T extends ConfigKeyBuilder<?>> {
  ...
  /**
   * The default value for the config key.  Defaults to {@link ConfigDef#NO_DEFAULT_VALUE}.
   */
  ...
  /**
   * The width of the input field for this config.  Defaults to {@link ConfigDef.Width#NONE}
   */
  ...
  /**
   * The set of names for {@link ConfigDef.ConfigKey}s that are dependent upon this key.
   */
  ...
  /**
   * The internal config key for this builder.  If set to {@code true} the configuration will be an internal config.
   ...
   * @param name the name of the key being built.
   */
   ...
   * @param orderInGroup the order in the group.
   * @return this
   */
   ...
   * @param dependents the dependents to add.
   * @return this.
   * @see #dependents
   */
  ...
  /**
   * Gets the list of dependents.  Dependents are only listed once and are in alphabetical order.
   ...
   * @param internalConfig the value for the flag.
   * @return this.
   */
