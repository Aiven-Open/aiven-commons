 ...
 * @see <a href="https://github.com/apache/httpcomponents-core/blob/master/httpcore5/src/main/java/org/apache/hc/core5/http/impl/EnglishReasonPhraseCatalog.java">EnglishReasonPhraseCatalog</a>
 */
...
public class HttpStrings {
    ...
    public static String getReason(final int status) {
        ...
        String reason = null;
        if (category > 0 && category < REASON_PHRASES.length &&
